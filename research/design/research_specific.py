...
# Kajetan Bielecki portfolio
urls = [
    ("01", "https://dribbble.com/kajeet"),
]

for tag, url in urls:
    send({"jsonrpc":"2.0","id":int(tag),"method":"tools/call","params":{"name":"browser_navigate","arguments":{"url": url}}})
    time.sleep(4)
    send({"jsonrpc":"2.0","id":int(tag)+50,"method":"tools/call","params":{"name":"browser_take_screenshot","arguments":{"type":"png","filename":f"/home/bons/.playwright-mcp/kajeet.png","fullPage":True}}})
    print(f"{tag}:", "ok")
